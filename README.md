...
|----------|:-------------:|------:|
| Заемщики |  EDA: Исследование факторов влияющих на общий возврат кредитных средств| Завершён(очередь на размещение) |
|  Недвижилость |   EDA: Исследование факторов влияющих на стоимость недвижимости в СПБ и Лен.области |   Завершён(очередь на размещение)|
|  Видеоигры| Планирование кампании по продажи видеоигр на следующий год | Завершён(очередь на размещение)|
